        ...
        <div class="tw-relative tw-z-10">
          <div class="tw-flex tw-items-center tw-gap-3 tw-mb-2">
            <div class="tw-bg-white/20 tw-p-2 tw-rounded-lg tw-backdrop-blur-sm">
              <q-icon name="assignment" size="sm" class="tw-text-white" />
            </div>
            <div class="text-h6 tw-font-bold tw-text-white tw-drop-shadow-lg">Report SPK</div>
          </div>
...
const allMenus = [
  { name: 'Monitoring SPK',  icon: 'assessment',      color: '#33bad0', link: '/report/monitoring-spk' },
  { name: 'SPK Total',       icon: 'bar_chart',        color: '#3eda7d', link: '/report/spk/total' },
  { name: 'SPK General',     icon: 'stacked_bar_chart',color: '#7c3aed', link: '/report/spk/general' },
  { name: 'SPK Mold',        icon: 'view_in_ar',       color: '#f59e0b', link: '/report/spk/mold' },
  { name: 'Grafik Gantt',    icon: 'view_timeline',    color: '#ec4899', link: '/report/sla/gantt/chart' },
];
