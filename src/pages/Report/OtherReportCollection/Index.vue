        ...
        <div class="tw-relative tw-z-10">
          ...
          <div class="tw-flex tw-items-center tw-gap-1 tw-text-white/90 tw-text-sm">
            ...
            <router-link
              ...
              :to="{ path: '/collection/report-lainnya' }">
              Report Lainnya
            </router-link>
          </div>
        </div>
...
const allMenus = [
  { name: 'Operator & Mesin Hours', icon: 'schedule',      color: '#33bad0', link: '/report/operator-mesin-hours' },
  { name: 'Overtime',               icon: 'more_time',     color: '#ec5252', link: '/report/overtime' },
  { name: 'Produktivitas Operator', icon: 'speed',         color: '#3eda7d', link: '/report/tjkn' },
  { name: 'Performance Employee',   icon: 'leaderboard',   color: '#7c3aed', link: '/report/performance/employee' },
];
